...
function ctrl.sec.btn(o)
    o = o or {}
    for k, v in pairs(default.btn) do o[k] = o[k] or v end
    local btn = CreateFrame('Button', o.name, o.f, 'SecureActionButtonTemplate')
    btn:SetSize(o.w, o.h)
...
function ctrl.secure.compile(btn, f)
